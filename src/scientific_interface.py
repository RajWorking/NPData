...
class ScientificInterface:
    ...
    def getNationalParkofSpecies(self):
        ...
        query = " SELECT N.name, P.genus, P.specific_name, S.name, " \
                " P.abundance, P.occurence FROM National_Park N, Presence P, Species S" \
                " WHERE N.unit_code = P.national_park AND (P.genus, P.specific_name) = (S.genus, S.specific_name)" \
