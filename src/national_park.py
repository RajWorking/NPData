class NationalPark:
    ...
    def add(self):
        ...
        query = """
        INSERT INTO National_Park(unit_code, name, region_code, boundary, latitude, longitude) 
    ...
    def remove(self):
        print("Enter National Park to delete: ")
        self.unitcode = int(input("Enter unitcode: "))

        query = """
                DELETE FROM National_Park 
                WHERE unit_code IS %s
                """

        values = (self.unitcode)
